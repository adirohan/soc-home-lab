...
Wazuh successfully collected Windows process creation telemetry generated by the endpoint.
...
The Wazuh Events dashboard was checked for the Windows endpoint after the controlled process creation activity.

The event telemetry confirmed that Wazuh was receiving Windows process creation data from SOC-WIN01.
...
This lab demonstrated the following detection workflow:
